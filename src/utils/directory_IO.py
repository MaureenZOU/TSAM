...
class RootInputDirectories:
    ...
    def __init__(
        ...
        root_masks_dir,
        root_flows_dir=None,
        root_flowmasks_dir=None,
        video_names_filename=None
    ):
        self.root_videos_dir = root_videos_dir
        self.root_masks_dir = root_masks_dir
        self.root_flows_dir = root_flows_dir
        self.root_flowmasks_dir = root_flowmasks_dir
...
class VideoDirectories:
    ...
    def __init__(
        ...
        self.flows_dir = os.path.join(rid.root_flows_dir, video_name)
        self.flowmasks_dir = os.path.join(rid.root_flowmasks_dir, video_name)
